...
class Huaweicloud extends Device
{
    ...
    /**
     * Huawei Cloud Regions constants
     */
    const AF_SOURTH_1 = 'af-south-1';
    const CN_NORTH_4 = 'cn-north-4';
    const CN_NORTH_1 = 'cn-north-1';
    const CN_NORTH_9 = 'cn-north-9';
    const CN_EAST_2 = 'cn-east-2';
    const CN_EAST_3 = 'cn-east-3';
    const CN_SOUTH_1 = 'cn-south-1';
    const CN_SOUTH_4= 'cn-south-4'; // 华南-广州-友好用户环境
    const CN_SOUTH_2 = 'cn-south-2'; // 华南-深圳

    /**
     * Huawei Cloud ACL Flag constants
     */
    ...
    {
        return 'Huawei Cloud Bucket Storage drive for Huawei or on premise solution';
    }
